...
var dtoTempBody = $.templates('#temp_simple_body');
var errorCodeTempBody = $.templates('#temp_simple2_body');
            ...
            $("[name='a_path']").click(function () {
                ...
                $.each(jsonData.paths[path], function (i, d) {
                    if (d.operationId == operationId) {
                        ...
                        d.method = method;
                        //console.log("=========="+path);
                        if (path.indexOf("/docs/errorCode") == 0) {
                            $("#path-body").html(errorCodeTempBody.render(d));
                        } else if (path.indexOf("/docs") == 0) {
                            $("#path-body").html(dtoTempBody.render(d));
                        } else {
